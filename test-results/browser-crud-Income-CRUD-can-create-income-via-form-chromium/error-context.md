...
- Name: browser\crud.spec.ts >> Income CRUD >> can create income via form
- Location: tests\browser\crud.spec.ts:38:3
...
Locator: locator('text=Test Income Source')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Test Income Source')
...
- main:
  ...
  - textbox "Income Source": Test Income Source
  - textbox "Amount": "1500.00"
  - textbox "Date": 2026-07-01
  - textbox "Description": Test income description
  - button "Add Income"
