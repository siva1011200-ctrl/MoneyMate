...
- Name: browser\crud.spec.ts >> Expense CRUD >> can view expense records in table
- Location: tests\browser\crud.spec.ts:125:3
...
Locator: locator('text=Utilities')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Utilities')
