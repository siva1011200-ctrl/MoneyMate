...
- Name: browser\crud.spec.ts >> Savings Goals CRUD >> persists savings goals after page reload
- Location: tests\browser\crud.spec.ts:253:3
...
Locator: locator('text=House Down Payment')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=House Down Payment')
