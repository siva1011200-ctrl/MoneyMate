...
- Name: browser\crud.spec.ts >> Savings Goals CRUD >> shows progress percentage
- Location: tests\browser\crud.spec.ts:243:3
...
Locator: locator('text=Vacation Fund')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Vacation Fund')
...
- main:
  ...
  - textbox "Savings Goal Name": Vacation Fund
  - spinbutton: "2000.00"
  - spinbutton: "1000.00"
