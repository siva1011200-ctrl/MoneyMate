...
- Name: browser\crud.spec.ts >> Budget CRUD >> can create a budget
- Location: tests\browser\crud.spec.ts:174:3
...
Locator: locator('text=Entertainment')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Entertainment')
...
- navigation:
  ...
  - text: Hi, Budget CRUD Tester
  - button "🌙 Dark"
  - button "Logout"
- main:
  - heading "Budget Planner" [level=1]
  - heading "Monthly Budgets" [level=2]
  - heading "Add Budget" [level=2]
  - textbox "Budget Category": Entertainment
  - spinbutton: "500.00"
  - spinbutton: "7"
  - spinbutton: "2026"
  - button "Add Budget"
