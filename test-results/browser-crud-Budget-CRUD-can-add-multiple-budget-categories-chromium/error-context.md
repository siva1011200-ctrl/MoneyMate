...
- Name: browser\crud.spec.ts >> Budget CRUD >> can add multiple budget categories
- Location: tests\browser\crud.spec.ts:206:3
...
- main:
  ...
  - textbox "Budget Category": Transport
  - spinbutton: "1000.00"
  - spinbutton: "7"
  - spinbutton: "2026"
  - button "Add Budget"
